...
df_combined_1_2.to_parquet(r'../Datasets/nuevos/autos_electricos.parquet', index=False)
...
# Transformo el dataset a tipo .parquet
df_combined_3_4.to_parquet(r'../Datasets/nuevos/localizacion.parquet', index=False)


# DATASET 5, 6, 7
df5 = pd.read_csv(r'../Datasets/sucios/Light_Duty_Vehicles.csv')
df6 = pd.read_csv(r'../Datasets/sucios/Vehicle_Fuel_Economy_Data.csv', low_memory=False)
...
df_combined_5_6_7.to_parquet(r'../Datasets/nuevos/autos_combustion.parquet', index=False)
df_combined_1_2.to_parquet(r'../Datasets/nuevos/autos_electricos.parquet', index=False)
df_combined_3_4.to_parquet(r'../Datasets/nuevos/localizacion.parquet', index=False)
...
combined_taxis.to_parquet(r'../Datasets/nuevos/taxis.parquet', index='False')
...
df_lugares_unicos.to_csv('../Datasets/nuevos/lugares_unicos.csv', index=False)
...
df_NYC_air_quality.to_parquet('../Datasets/nuevos/NYC_air_quality.parquet', index=False)
...
# Transformo el dataset a tipo .parquet
df_NYC_sonidos.to_parquet(r'../Datasets/nuevos/NYC_sonidos.parquet', index=False)
